...
<?php 
 ...
 if(!isset($_SESSION['usertype'])){
  ...
  $udsql = "SELECT * FROM `creator` as c JOIN `user` as u ON c.userid = u.userid WHERE `creatortype` = 'videographer' order by createdon desc";
...
<body>
    ...
    <h3 class="table-heading"  style="text-align:center">Registered Videographers</h3>
    <br />
    <main>
        <div class="">
        <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($item['status'] == 'pending'): ?>
                                <a
                                    href="admin-video.php?action=approved&creatorid=<?php echo $item['creatorid']; ?>">Approve</a>
                                <a
                                    href="admin-video.php?action=rejected&creatorid=<?php echo $item['creatorid']; ?>">Reject</a>
                            <?php else: ?>
